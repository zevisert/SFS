...
inline void load_FAT_entry(FAT_entry** table, const byte* disk, unsigned int FAT_offset, int entry)
{
...
inline void update_disk_FAT(FAT_entry** table, byte* disk, unsigned int FAT_offset, int entry)
{
